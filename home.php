    ...
    <section class="cards">
        ...
        <div class="card" id="card"><img src="images\im1.jpg" alt="Card 1">
            <div class="container" id="container">
                ...
                <p>Experience the future of parking with our *Automated Parking System*, designed for maximum efficiency and convenience. This advanced system automates the process of parking your car, reducing the time and effort traditionally required. Simply drive up to the designated area,<span id="dots">...</span><span id="more"> and our technology takes care of the rest—finding a suitable space, safely parking your vehicle, and retrieving it when you're ready to leave. This system not only saves space and time but also improves security and reduces the risk of damage, providing a seamless parking experience for drivers in busy urban areas."
                </span></p>
